using me.cqp.luohuaming.Story.Tool.IniConfig.Attribute;
using me.cqp.luohuaming.Story.Tool.IniConfig.Exception;
using me.cqp.luohuaming.Story.Tool.IniConfig.Linq;
using System;
...
namespace me.cqp.luohuaming.Story.Tool.IniConfig
{
	/// <summary>
