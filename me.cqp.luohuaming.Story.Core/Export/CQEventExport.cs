...
using me.cqp.luohuaming.Story.Core;
using me.cqp.luohuaming.Story.Core.Domain;
using me.cqp.luohuaming.Story.Sdk.Cqp;
using me.cqp.luohuaming.Story.Sdk.Cqp.Enum;
using me.cqp.luohuaming.Story.Sdk.Cqp.EventArgs;
using me.cqp.luohuaming.Story.Sdk.Cqp.Interface;
using me.cqp.luohuaming.Story.Sdk.Cqp.Expand;
using me.cqp.luohuaming.Story.Sdk.Cqp.Model;
using Unity;
using Unity.Injection;

namespace me.cqp.luohuaming.Story.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.Story";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.Story", 1, 9, "水银续写机", "1.0.2", 1, "落花茗", "基于彩云小梦尝鲜版的续写Bot", authCode);	
			appDataType.GetRuntimeProperty ("CQApi").GetSetMethod (true).Invoke (null, new object[] { new CQApi (appInfo) });	
			AppData.UnityContainer.RegisterInstance<CQApi> ("me.cqp.luohuaming.Story", AppData.CQApi);	
			// 向容器注册一个 CQLog 实例	
			appDataType.GetRuntimeProperty ("CQLog").GetSetMethod (true).Invoke (null, new object[] { new CQLog (authCode) });	
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.Story", AppData.CQLog);	
